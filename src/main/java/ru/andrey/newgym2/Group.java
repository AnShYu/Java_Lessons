...
public class Group {
    ...
    private List<ru.andrey.gym.TrainingDay> groupSchedule = new ArrayList<>();
    private ru.andrey.gym.Coach coach;
    ...
    public Group(String groupName, ru.andrey.gym.Coach coach) {
    ...
    public void addTrainingDay (int newDay, int newHour, int newMinute) {
        ru.andrey.gym.TrainingDay newTrainingDay = new ru.andrey.gym.TrainingDay(newDay, newHour, newMinute);
    ...
    public void deleteTrainingDay (ru.andrey.gym.TrainingDay dayToDelete) {
